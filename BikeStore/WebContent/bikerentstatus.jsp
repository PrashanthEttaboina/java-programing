						...
						<div class="panel-heading">
							...
							<form action="bikerentstatus1.jsp" method="post">
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											<label>Bike Model</label> <input type="text" name="bm"
												class="form-control" style="width: 260px;"
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											<label>Rent(per day)</label> <input type="text" name="rent"
												class="form-control" style="width: 260px;"
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<label>Store Email</label> <input type="text" name="bsemail"
												class="form-control" style="width: 260px;"
												value="<%=rs.getString(7)%>" readonly>
										</div></div>
										<div class="col-md-6">
											<div class="form-group">
												<label>Booking Date</label> <input type="date" name="bd"
													class="form-control" style="width: 260px;" required>
											</div></div></div>
