		...
		<div class="container">
			<div class="row">
				...
				<div
					...
					data-wow-delay="0.2s">
					<img src="images/admin-img.jpeg" class="img-responsive" alt="Home"
				...
				<div class="col-md-6 col-sm-7 col-xs-12">
					...
					<div class="panel-heading">
						<h3 class="panel-title">
							<span class="fa fa-pencil-square-o"></span><font size="6">Admin
								Login 
						</h3>
						</font>
					</div>
					...
					<form action="./alogincheck.jsp" method="post">
						<div class="form-group">
							<label>Username:</label> <input type="text" class="form-control" style="width: 300px;"
								name="uname" placeholder="Enter Username" required="required">
						</div>
						<div class="form-group">
