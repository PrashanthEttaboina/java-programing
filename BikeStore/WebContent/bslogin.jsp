		...
		<div class="container">
			<div class="row">
				...
				<div
					...
					data-wow-delay="0.2s">
					<img src="images/seller-page.jpeg" class="img-responsive"
						alt="Home"
				...
				<div class="col-md-6 col-sm-7 col-xs-12">
					...
					<div class="panel-heading">
						<h3 class="panel-title">
							<span class="fa fa-pencil-square-o"></span><font size="6">Seller
								Login
						</h3>
						</font>
					</div>
					<form action="bslogincheck.jsp" method="post">
						<div class="form-group">
							<label>Email</label> <input type="email" class="form-control"
								style="width: 300px;" name="bsemail" placeholder="enter email">
						</div>
						<div class="form-group">
							<label>Password</label> <input type="password"
								class="form-control" style="width: 300px;" name="password"
								placeholder="enter password" required>
						</div>
						<input type="submit" class="btn btn-primary" value="Login">
						<input type="reset" class="btn btn-primary" value="reset">
						<a href="bsreg.jsp" class="btn btn-primary" value="Register">Register</a><br>
