			...
			<div class="row">
				...
				<div
					...
					<img src="images/home-img.png" class="img-responsive" alt="Home"
						style="padding-right: 10‒; padding-right: 80px; padding-left: 20px;">
				</div>

				<div class="col-md-6 col-sm-7 col-xs-12"><br>
					...
					<form action="uinsert.jsp" method="post">
						<div class="row">
 						 <div class="col-md-6">
						<div class="form-group">
							<label>Name</label> <input type="text" name="uname" style="width: 250px;"
								class="form-control" placeholder="enter user name">
						</div>
						</div>
						<div class="col-md-6">
						<div class="form-group">
							<label>Email</label><input type="email" class="form-control" style="width: 260px;"
						...
						<div class="row">
 						 <div class="col-md-6">
						<div class="form-group">
							<label>Password</label> <input type="password" style="width: 250px;"
 						 ...
 						 <div class="col-md-6">
						<div class="form-group">
							<label>Phone number</label> <input type="text" style="width: 260px;"
						...
						<div class="form-group">
							<label>Address</label>
							<textarea cols="10" class="form-control" name="uadd" 
