				...
				<div class="row"><br>
					...
					<table class="table table-dark">
						...
						<tr>
							...
							<td><a href="bikeservicestatus.jsp?id=<%=rs.getString(1)%>" class="btn btn-success">Book</a></td>
						</tr>
						<%
							}
						%>
