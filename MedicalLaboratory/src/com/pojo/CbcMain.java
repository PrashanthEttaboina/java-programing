...
public class CbcMain {
	...
	private int c_id,age,hemoglobin,rbc,plt,esr,lab_doc_id;
	private String phane,pgender,pemail,phone,blood_group,test_name,referred_by_doc,referred_by_hospital,date_and_time,report_details,test_status,pathologist_name;
	public int getC_id() {
		return c_id;
	}
	...
	public String getPhane() {
		return phane;
	}
	public void setPhane(String phane) {
		this.phane = phane;
	}
