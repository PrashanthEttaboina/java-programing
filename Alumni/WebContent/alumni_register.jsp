...
<%@page import="com.pojo.College,java.util.*,com.directorate.ManageCollegeBean"%>
					...
					<div class="card-body">
						<form action="./alumni_register" method="post">
							...
							<div class="form-group">
								...
								<% 
								List li= ManageCollegeBean.getColleges();
								Iterator i = li.iterator();
								while (i.hasNext()) {
								College f = (College) i.next();															
								%>								
								 <option value="<%=f.getCname()%>"><%=f.getCname()%></option>
								 <%} %>
								 </select>
							</div>
