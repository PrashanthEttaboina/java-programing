...
public class AppointmentBean {
	...
	public boolean appoint(String patient_name,String phone,String email,String gender,String blood_group,String specialist,String date_of_appointment,String time_of_appointment,int pid) throws ClassNotFoundException, SQLException {
	...
	public List<AppointmentBean> status(int aid) throws ClassNotFoundException, SQLException{
		...
		while(rs.next()) {
			...
			ab.setPid(rs.getInt(12));
			appointment_details.add(ab);
		}
